...
namespace NewBrowseCapTest
{
    ...
    public class BrowscapXmlHelper
    {
        ...
        public BrowscapXmlHelper(string userAgentStringsPath, string crawlerOnlyUserAgentStringsPath, bool useCompilation = false)
        {
            Initialize(userAgentStringsPath, crawlerOnlyUserAgentStringsPath, useCompilation);
        }

        private void Initialize(string userAgentStringsPath, string crawlerOnlyUserAgentStringsPath, bool useCompilation)
        {
            ...
            var crawlerRegexPattern = string.Join("|",
                crawlerItems
            ...
            if (useCompilation)
            {
                _crawlerUserAgentsRegexp = new Regex(crawlerRegexPattern, RegexOptions.Compiled);
            }
            else
            {
                _crawlerUserAgentsRegexp = new Regex(crawlerRegexPattern);
            }
